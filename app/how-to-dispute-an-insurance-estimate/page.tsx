...
export const metadata: Metadata = {
  ...
  description: "Professional how to dispute an insurance estimate service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
