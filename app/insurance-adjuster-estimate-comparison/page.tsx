...
export const metadata: Metadata = {
  ...
  description: "Professional insurance adjuster estimate comparison service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
