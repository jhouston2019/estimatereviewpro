  ...
  return (
    <SeoLandingPage
      ...
      faqs={[
          ...
          {
                    "question": "How long does condo association estimate review take?",
          ...
          {
                    "question": "What makes your condo association estimate review different from manual review?",
                    "answer": "Our AI-powered approach combines speed, consistency, and comprehensiveness that manual review can't match. The system never gets tired, never overlooks line items, and applies the same rigorous analysis to every estimate. For property associations, this means receiving thorough review at a fraction of the cost and time of hiring a public adjuster or consultant. The AI also compares against constantly updated regional pricing databases, ensuring your analysis reflects current market conditions for property damage restoration."
          },
          {
                    "question": "Can I use your condo association estimate review report to negotiate with my insurance company?",
                    "answer": "Absolutely. Our reports are specifically designed for insurance negotiations and claim supplements. The PDF includes detailed, line-item documentation that insurance adjusters can verify against their own databases. Many property associations successfully use our reports to secure additional compensation, with some recovering tens of thousands in previously overlooked damage. The objective, third-party nature of AI analysis often carries more weight than homeowner assertions alone."
          },
          {
                    "question": "What if my property damage estimate is from Xactimate?",
                    "answer": "We specialize in Xactimate estimate analysis. Our AI recognizes Xactimate line codes, pricing structures, and formatting. For property associations dealing with insurance carrier estimates, this expertise is crucial—we can identify when Xactimate pricing is outdated, when line codes are misapplied, or when quantities don't match the described damage. The system also compares Xactimate pricing against current market rates to identify discrepancies."
          },
          {
                    "question": "How much does condo association estimate review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "condo association estimate review",
        "provider": {
          "@type": "Organization",
