...
export const metadata: Metadata = {
  title: "Roof Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional roof estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
...
export default function RoofEstimateReviewPage() {
  return (
    <SeoLandingPage
      ...
      sections={[
          {
                    "heading": "Understanding Roof Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Roof Estimate Review Is Essential",
          ...
          {
                    "heading": "The Roof Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Roof Estimate Review Deliverables",
      ...
      faqs={[
          ...
          {
                    "question": "What makes your roof estimate review different from manual review?",
          ...
          {
                    "question": "How much does roof estimate review cost?",
