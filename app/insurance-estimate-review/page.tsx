...
export const metadata: Metadata = {
  title: "Insurance Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional insurance estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
...
export default function InsuranceEstimateReviewPage() {
  return (
    <SeoLandingPage
      ...
      sections={[
          {
                    "heading": "Understanding Insurance Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Insurance Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Insurance Estimate Review Works",
          ...
          {
                    "heading": "The Insurance Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Insurance Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered insurance estimate review?",
          ...
          {
                    "question": "How long does insurance estimate review take?",
          ...
          {
                    "question": "What makes your insurance estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your insurance estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does insurance estimate review cost?",
