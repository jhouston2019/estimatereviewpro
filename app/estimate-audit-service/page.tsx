...
export const metadata: Metadata = {
  title: "Estimate Audit Service | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional estimate audit service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function EstimateAuditServicePage() {
  return (
    <SeoLandingPage
      title="Estimate Audit Service"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional estimate audit service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Estimate Audit Service Challenges",
          ...
          {
                    "heading": "Why Professional Estimate Audit Service Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Estimate Audit Service Works",
          ...
          {
                    "heading": "The Estimate Audit Service Process",
          ...
          {
                    "heading": "Comprehensive Estimate Audit Service Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered estimate audit service?",
          ...
          {
                    "question": "How long does estimate audit service take?",
          ...
          {
                    "question": "What makes your estimate audit service different from manual review?",
          ...
          {
                    "question": "Can I use your estimate audit service report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does estimate audit service cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "estimate audit service",
        "provider": {
          "@type": "Organization",
