...
export const metadata: Metadata = {
  ...
  description: "Professional how to identify missing items in a claim service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
