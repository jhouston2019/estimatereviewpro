  ...
  return (
    <SeoLandingPage
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "compare contractor and insurance estimate",
        "provider": {
          "@type": "Organization",
