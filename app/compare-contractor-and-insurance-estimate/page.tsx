...
export const metadata: Metadata = {
  ...
  description: "Professional compare contractor and insurance estimate service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
