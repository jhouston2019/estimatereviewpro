...
export const metadata: Metadata = {
  title: "Claim Estimate Review Service | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional claim estimate review service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function ClaimEstimateReviewServicePage() {
  return (
    <SeoLandingPage
      title="Claim Estimate Review Service"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional claim estimate review service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Claim Estimate Review Service Challenges",
          ...
          {
                    "heading": "Why Professional Claim Estimate Review Service Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Claim Estimate Review Service Works",
          ...
          {
                    "heading": "The Claim Estimate Review Service Process",
          ...
          {
                    "heading": "Comprehensive Claim Estimate Review Service Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered claim estimate review service?",
          ...
          {
                    "question": "How long does claim estimate review service take?",
          ...
          {
                    "question": "What makes your claim estimate review service different from manual review?",
          ...
          {
                    "question": "Can I use your claim estimate review service report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does claim estimate review service cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "claim estimate review service",
        "provider": {
          "@type": "Organization",
