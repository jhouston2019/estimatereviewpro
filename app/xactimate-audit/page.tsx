...
export const metadata: Metadata = {
  title: "Xactimate Audit | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional Xactimate audit service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function XactimateAuditPage() {
  return (
    <SeoLandingPage
      title="Xactimate Audit"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional Xactimate audit service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Xactimate Audit Challenges",
          ...
          {
                    "heading": "Why Professional Xactimate Audit Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Xactimate Audit Works",
          ...
          {
                    "heading": "The Xactimate Audit Process",
          ...
          {
                    "heading": "Comprehensive Xactimate Audit Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered Xactimate audit?",
          ...
          {
                    "question": "How long does Xactimate audit take?",
          ...
          {
                    "question": "What makes your Xactimate audit different from manual review?",
          ...
          {
                    "question": "Can I use your Xactimate audit report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does Xactimate audit cost?",
