  ...
  return (
    <SeoLandingPage
      ...
      faqs={[
          ...
          {
                    "question": "How long does contractor estimate verification take?",
                    "answer": "Most property damage estimates are fully analyzed in 5-10 minutes. Complex multi-trade estimates or large commercial properties may take up to 15 minutes. You'll receive real-time progress updates and can download your comprehensive PDF report immediately upon completion. This is dramatically faster than traditional validation services that can take days or weeks."
          },
          {
                    "question": "What makes your contractor estimate verification different from manual review?",
                    "answer": "Our AI-powered approach combines speed, consistency, and comprehensiveness that manual review can't match. The system never gets tired, never overlooks line items, and applies the same rigorous analysis to every estimate. For contractors, this means receiving thorough validation at a fraction of the cost and time of hiring a public adjuster or consultant. The AI also compares against constantly updated regional pricing databases, ensuring your analysis reflects current market conditions for property damage restoration."
          },
          {
                    "question": "Can I use your contractor estimate verification report to negotiate with my insurance company?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "contractor estimate verification",
        "provider": {
          "@type": "Organization",
