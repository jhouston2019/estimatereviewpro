...
export const metadata: Metadata = {
  ...
  description: "Professional professional estimate audit service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
