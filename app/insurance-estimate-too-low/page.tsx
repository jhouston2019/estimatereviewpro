...
export const metadata: Metadata = {
  ...
  description: "Professional insurance estimate too low service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
