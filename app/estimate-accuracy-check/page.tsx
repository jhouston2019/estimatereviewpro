...
export const metadata: Metadata = {
  title: "Estimate Accuracy Check | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional estimate accuracy check service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function EstimateAccuracyCheckPage() {
  return (
    <SeoLandingPage
      title="Estimate Accuracy Check"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional estimate accuracy check service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Estimate Accuracy Check Challenges",
          ...
          {
                    "heading": "Why Professional Estimate Accuracy Check Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Estimate Accuracy Check Works",
          ...
          {
                    "heading": "The Estimate Accuracy Check Process",
          ...
          {
                    "heading": "Comprehensive Estimate Accuracy Check Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered estimate accuracy check?",
          ...
          {
                    "question": "How long does estimate accuracy check take?",
          ...
          {
                    "question": "What makes your estimate accuracy check different from manual review?",
          ...
          {
                    "question": "Can I use your estimate accuracy check report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does estimate accuracy check cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "estimate accuracy check",
        "provider": {
          "@type": "Organization",
