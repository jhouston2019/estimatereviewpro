...
export const metadata: Metadata = {
  title: "Homeowner Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional homeowner estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function HomeownerEstimateReviewPage() {
  return (
    <SeoLandingPage
      title="Homeowner Estimate Review"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional homeowner estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Homeowner Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Homeowner Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Homeowner Estimate Review Works",
          ...
          {
                    "heading": "The Homeowner Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Homeowner Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered homeowner estimate review?",
          ...
          {
                    "question": "How long does homeowner estimate review take?",
          ...
          {
                    "question": "What makes your homeowner estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your homeowner estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does homeowner estimate review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "homeowner estimate review",
        "provider": {
          "@type": "Organization",
