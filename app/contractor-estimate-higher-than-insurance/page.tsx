...
export const metadata: Metadata = {
  ...
  description: "Professional contractor estimate higher than insurance service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
