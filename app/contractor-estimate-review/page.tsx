...
export const metadata: Metadata = {
  ...
  description: "Professional contractor estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
...
export default function ContractorEstimateReviewPage() {
  return (
    <SeoLandingPage
      ...
      sections={[
          {
                    "heading": "Understanding Contractor Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Contractor Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Contractor Estimate Review Works",
          ...
          {
                    "heading": "Comprehensive Contractor Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered contractor estimate review?",
          ...
          {
                    "question": "How long does contractor estimate review take?",
          ...
          {
                    "question": "What makes your contractor estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your contractor estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does contractor estimate review cost?",
