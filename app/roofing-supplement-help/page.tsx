...
export const metadata: Metadata = {
  title: "Roofing Supplement Help | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional roofing supplement help service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function RoofingSupplementHelpPage() {
  return (
    <SeoLandingPage
      title="Roofing Supplement Help"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional roofing supplement help service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Roofing Supplement Help Challenges",
          ...
          {
                    "heading": "Why Professional Roofing Supplement Help Is Essential",
      ...
      faqs={[
          ...
          {
                    "question": "How long does roofing supplement help take?",
          ...
          {
                    "question": "What makes your roofing supplement help different from manual review?",
          ...
          {
                    "question": "Can I use your roofing supplement help report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does roofing supplement help cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "roofing supplement help",
        "provider": {
          "@type": "Organization",
