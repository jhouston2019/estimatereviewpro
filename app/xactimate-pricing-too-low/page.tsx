...
export const metadata: Metadata = {
  ...
  description: "Professional Xactimate pricing too low service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
