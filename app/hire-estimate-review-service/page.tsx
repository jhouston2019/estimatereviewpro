...
export const metadata: Metadata = {
  ...
  description: "Professional hire estimate review service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
