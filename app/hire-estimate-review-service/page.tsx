...
export const metadata: Metadata = {
  title: "Hire Estimate Review Service | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional hire estimate review service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function HireEstimateReviewServicePage() {
  return (
    <SeoLandingPage
      title="Hire Estimate Review Service"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional hire estimate review service service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Hire Estimate Review Service Challenges",
          ...
          {
                    "heading": "Why Professional Hire Estimate Review Service Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Hire Estimate Review Service Works",
          ...
          {
                    "heading": "The Hire Estimate Review Service Process",
          ...
          {
                    "heading": "Comprehensive Hire Estimate Review Service Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered hire estimate review service?",
          ...
          {
                    "question": "How long does hire estimate review service take?",
          ...
          {
                    "question": "What makes your hire estimate review service different from manual review?",
          ...
          {
                    "question": "Can I use your hire estimate review service report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does hire estimate review service cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "hire estimate review service",
        "provider": {
          "@type": "Organization",
