...
export const metadata: Metadata = {
  title: "Xactimate Discrepancies | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional Xactimate discrepancies service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function XactimateDiscrepanciesPage() {
  return (
    <SeoLandingPage
      title="Xactimate Discrepancies"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional Xactimate discrepancies service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Xactimate Discrepancies Challenges",
          ...
          {
                    "heading": "Why Professional Xactimate Discrepancies Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Xactimate Discrepancies Works",
          ...
          {
                    "heading": "The Xactimate Discrepancies Process",
          ...
          {
                    "heading": "Comprehensive Xactimate Discrepancies Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered Xactimate discrepancies?",
          ...
          {
                    "question": "How long does Xactimate discrepancies take?",
          ...
          {
                    "question": "What makes your Xactimate discrepancies different from manual review?",
          ...
          {
                    "question": "Can I use your Xactimate discrepancies report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does Xactimate discrepancies cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "Xactimate discrepancies",
        "provider": {
          "@type": "Organization",
