...
export const metadata: Metadata = {
  title: "Roofer Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional roofer estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function RooferEstimateReviewPage() {
  return (
    <SeoLandingPage
      title="Roofer Estimate Review"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional roofer estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Roofer Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Roofer Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Roofer Estimate Review Works",
          ...
          {
                    "heading": "The Roofer Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Roofer Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered roofer estimate review?",
          ...
          {
                    "question": "How long does roofer estimate review take?",
          ...
          {
                    "question": "What makes your roofer estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your roofer estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does roofer estimate review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "roofer estimate review",
        "provider": {
          "@type": "Organization",
