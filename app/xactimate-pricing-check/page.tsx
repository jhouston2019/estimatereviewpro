...
export const metadata: Metadata = {
  title: "Xactimate Pricing Check | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional Xactimate pricing check service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function XactimatePricingCheckPage() {
  return (
    <SeoLandingPage
      title="Xactimate Pricing Check"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional Xactimate pricing check service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Xactimate Pricing Check Challenges",
          ...
          {
                    "heading": "Why Professional Xactimate Pricing Check Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Xactimate Pricing Check Works",
          ...
          {
                    "heading": "The Xactimate Pricing Check Process",
          ...
          {
                    "heading": "Comprehensive Xactimate Pricing Check Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered Xactimate pricing check?",
          ...
          {
                    "question": "How long does Xactimate pricing check take?",
          ...
          {
                    "question": "What makes your Xactimate pricing check different from manual review?",
          ...
          {
                    "question": "Can I use your Xactimate pricing check report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does Xactimate pricing check cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "Xactimate pricing check",
        "provider": {
          "@type": "Organization",
