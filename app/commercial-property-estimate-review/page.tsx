...
export const metadata: Metadata = {
  ...
  description: "Professional commercial property estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to maximize your insurance claim settlement.",
};
