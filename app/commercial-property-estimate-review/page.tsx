  ...
  return (
    <SeoLandingPage
      ...
      faqs={[
          ...
          {
                    "question": "How long does commercial property estimate review take?",
          ...
          {
                    "question": "What makes your commercial property estimate review different from manual review?",
                    "answer": "Our AI-powered approach combines speed, consistency, and comprehensiveness that manual review can't match. The system never gets tired, never overlooks line items, and applies the same rigorous analysis to every estimate. For commercial property owners, this means receiving thorough review at a fraction of the cost and time of hiring a public adjuster or consultant. The AI also compares against constantly updated regional pricing databases, ensuring your analysis reflects current market conditions for property damage restoration."
          },
          {
                    "question": "Can I use your commercial property estimate review report to negotiate with my insurance company?",
                    "answer": "Absolutely. Our reports are specifically designed for insurance negotiations and claim supplements. The PDF includes detailed, line-item documentation that insurance adjusters can verify against their own databases. Many commercial property owners successfully use our reports to secure additional compensation, with some recovering tens of thousands in previously overlooked damage. The objective, third-party nature of AI analysis often carries more weight than homeowner assertions alone."
          },
          {
                    "question": "What if my property damage estimate is from Xactimate?",
                    "answer": "We specialize in Xactimate estimate analysis. Our AI recognizes Xactimate line codes, pricing structures, and formatting. For commercial property owners dealing with insurance carrier estimates, this expertise is crucial—we can identify when Xactimate pricing is outdated, when line codes are misapplied, or when quantities don't match the described damage. The system also compares Xactimate pricing against current market rates to identify discrepancies."
          },
          {
                    "question": "How much does commercial property estimate review cost?",
                    "answer": "Single estimate review costs $79, providing complete analysis and a professional PDF report. For commercial property owners handling multiple claims—such as public adjusters, contractors, or property managers—our unlimited subscription at $249/month offers better value. The subscription includes priority processing, unlimited estimates, and white-label reporting options. Compared to hiring a public adjuster (typically 10-15% of the settlement), our service provides significant cost savings while delivering comprehensive analysis."
          }
]}
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "commercial property estimate review",
        "provider": {
          "@type": "Organization",
