...
export const metadata: Metadata = {
  title: "Rebuild Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional rebuild estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function RebuildEstimateReviewPage() {
  return (
    <SeoLandingPage
      title="Rebuild Estimate Review"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional rebuild estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Rebuild Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Rebuild Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Rebuild Estimate Review Works",
          ...
          {
                    "heading": "The Rebuild Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Rebuild Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered rebuild estimate review?",
          ...
          {
                    "question": "How long does rebuild estimate review take?",
          ...
          {
                    "question": "What makes your rebuild estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your rebuild estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does rebuild estimate review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "rebuild estimate review",
        "provider": {
          "@type": "Organization",
