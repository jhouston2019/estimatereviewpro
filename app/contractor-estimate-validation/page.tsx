...
export const metadata: Metadata = {
  title: "Contractor Estimate Validation | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional contractor estimate validation service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function ContractorEstimateValidationPage() {
  return (
    <SeoLandingPage
      title="Contractor Estimate Validation"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional contractor estimate validation service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Contractor Estimate Validation Challenges",
          ...
          {
                    "heading": "Why Professional Contractor Estimate Validation Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Contractor Estimate Validation Works",
          ...
          {
                    "heading": "The Contractor Estimate Validation Process",
          ...
          {
                    "heading": "Comprehensive Contractor Estimate Validation Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered contractor estimate validation?",
          ...
          {
                    "question": "How long does contractor estimate validation take?",
          ...
          {
                    "question": "What makes your contractor estimate validation different from manual review?",
          ...
          {
                    "question": "Can I use your contractor estimate validation report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does contractor estimate validation cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "contractor estimate validation",
        "provider": {
          "@type": "Organization",
