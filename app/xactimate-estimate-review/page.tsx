...
export const metadata: Metadata = {
  title: "Xactimate Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional Xactimate estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};
...
export default function XactimateEstimateReviewPage() {
  return (
    <SeoLandingPage
      ...
      sections={[
          {
                    "heading": "Understanding Xactimate Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Xactimate Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Xactimate Estimate Review Works",
          ...
          {
                    "heading": "The Xactimate Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Xactimate Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered Xactimate estimate review?",
          ...
          {
                    "question": "What makes your Xactimate estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your Xactimate estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does Xactimate estimate review cost?",
