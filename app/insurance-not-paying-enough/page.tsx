...
export const metadata: Metadata = {
  title: "Insurance Not Paying Enough | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional insurance not paying enough service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function InsuranceNotPayingEnoughPage() {
  return (
    <SeoLandingPage
      title="Insurance Not Paying Enough"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional insurance not paying enough service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Insurance Not Paying Enough Challenges",
          ...
          {
                    "heading": "Why Professional Insurance Not Paying Enough Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Insurance Not Paying Enough Works",
          ...
          {
                    "heading": "The Insurance Not Paying Enough Process",
          ...
          {
                    "heading": "Comprehensive Insurance Not Paying Enough Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered insurance not paying enough?",
          ...
          {
                    "question": "How long does insurance not paying enough take?",
          ...
          {
                    "question": "What makes your insurance not paying enough different from manual review?",
          ...
          {
                    "question": "Can I use your insurance not paying enough report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does insurance not paying enough cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "insurance not paying enough",
        "provider": {
          "@type": "Organization",
