...
export const metadata: Metadata = {
  title: "Xactimate Line Item Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional Xactimate line item review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function XactimateLineItemReviewPage() {
  return (
    <SeoLandingPage
      title="Xactimate Line Item Review"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional Xactimate line item review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Xactimate Line Item Review Challenges",
          ...
          {
                    "heading": "Why Professional Xactimate Line Item Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Xactimate Line Item Review Works",
          ...
          {
                    "heading": "The Xactimate Line Item Review Process",
          ...
          {
                    "heading": "Comprehensive Xactimate Line Item Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered Xactimate line item review?",
          ...
          {
                    "question": "How long does Xactimate line item review take?",
          ...
          {
                    "question": "What makes your Xactimate line item review different from manual review?",
          ...
          {
                    "question": "Can I use your Xactimate line item review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does Xactimate line item review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "Xactimate line item review",
        "provider": {
          "@type": "Organization",
