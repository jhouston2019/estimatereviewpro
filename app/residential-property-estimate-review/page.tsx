...
export const metadata: Metadata = {
  title: "Residential Property Estimate Review | AI-Powered Analysis | Estimate Review Pro",
  description: "Professional residential property estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies.",
};

export default function ResidentialPropertyEstimateReviewPage() {
  return (
    <SeoLandingPage
      title="Residential Property Estimate Review"
      subtitle="Structured Analysis for Claims Teams"
      description="Professional residential property estimate review service. AI-powered analysis identifies missing items, pricing discrepancies, and scope gaps to identify scope gaps and structural inconsistencies."
      sections={[
          {
                    "heading": "Understanding Residential Property Estimate Review Challenges",
          ...
          {
                    "heading": "Why Professional Residential Property Estimate Review Is Essential",
          ...
          {
                    "heading": "How Our AI-Powered Residential Property Estimate Review Works",
          ...
          {
                    "heading": "The Residential Property Estimate Review Process",
          ...
          {
                    "heading": "Comprehensive Residential Property Estimate Review Deliverables",
      ...
      faqs={[
          {
                    "question": "How accurate is AI-powered residential property estimate review?",
          ...
          {
                    "question": "How long does residential property estimate review take?",
          ...
          {
                    "question": "What makes your residential property estimate review different from manual review?",
          ...
          {
                    "question": "Can I use your residential property estimate review report to negotiate with my insurance company?",
          ...
          {
                    "question": "How much does residential property estimate review cost?",
      ...
      schema={{
        ...
        "@type": "Service",
        "serviceType": "residential property estimate review",
        "provider": {
          "@type": "Organization",
